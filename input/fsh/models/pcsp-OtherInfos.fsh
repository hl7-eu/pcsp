...
In this field must be reported the ordinal number of relevant event to be described."""				
* severeToxicity 0..10 BackboneElement "Important toxicity during treatment" """Important toxicity during treatment �"""				
...
* transfusion 0..1 BackboneElement "Transfusion" """Transfusion �"""				
