...
* target -> ".bodySite"				
* target -> ".extension(http://hl7.eu/fhir/ig/pcsp/StructureDefinition/ResourceRelatedInfo-eu-pcsp).resolve().conformsTo(http://hl7.eu/fhir/ig/pcsp/StructureDefinition/Observation-cumulativeDoseRad-eu-pcsp)"				
...
* target.position -> ".extension('http://hl7.org/fhir/us/mcode/StructureDefinition/mcode-body-location-qualifier').valueCodeableConcept"				
* target.totalDose -> ".extension(http://hl7.eu/fhir/ig/pcsp/StructureDefinition/ResourceRelatedInfo-eu-pcsp).resolve().conformsTo(http://hl7.eu/fhir/ig/pcsp/StructureDefinition/Observation-cumulativeDoseRad-eu-pcsp)"				
* target.totalDose.completionStatus -> ".status = #preliminary"				
* target.totalDose.statusReason -> ".extension('http://hl7.org/fhir/StructureDefinition/event-statusReason')"				
* target.totalDose.notKnown -> ".valueCodeableConcept = http://terminology.hl7.org/CodeSystem/data-absent-reason#unknown"				
* target.totalDose.dose -> ".valueQuantity.value"				
* target.totalDose.unit -> ".valueQuantity.code"				
* target.totalDose.fractions -> ".extension(http://hl7.eu/fhir/ig/pcsp/StructureDefinition/procedure-performedTiming).valueTiming.repeat.count"				
* target.boost -> "Procedure.conformsTo('http://hl7.eu/fhir/ig/pcsp/StructureDefinition/Procedure-radiotheraphyBoost-eu-pcsp')"				
* target.boost.type -> ".partOf.resolve().code"				
* target.boost.given -> ".status"				
* target.boost.site -> ".bodySite"				
