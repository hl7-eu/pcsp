...
* differential.element[5].id = "MedicalSuggestion.prescribedMedication.name"
* differential.element[5].path = "MedicalSuggestion.prescribedMedication.name"
* differential.element[5].short = "Name "
* differential.element[5].definition = "Drug name"
* differential.element[5].min = 0
* differential.element[5].max = "1"
* differential.element[5].type.code = #string
* differential.element[6].id = "MedicalSuggestion.prescribedMedication.dose"
* differential.element[6].path = "MedicalSuggestion.prescribedMedication.dose"
* differential.element[6].short = "Dose"
* differential.element[6].definition = "Drug dose. Quanity per administration"
* differential.element[6].min = 0
* differential.element[6].max = "*"
* differential.element[6].type.code = #Quantity
* differential.element[7].id = "MedicalSuggestion.prescribedMedication.schedule"
* differential.element[7].path = "MedicalSuggestion.prescribedMedication.schedule"
* differential.element[7].short = "Schedule"
* differential.element[7].definition = "Drug Schedule. When it should be administered"
