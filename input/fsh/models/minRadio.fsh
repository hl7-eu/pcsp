Instance: Radiotherapy-min
InstanceOf: StructureDefinition
Description: "Radiotherapy"
Title: "Radiotherapy (minimal)"
Usage: #definition
* publisher = "PanCareSurPass project"
* status = #draft
* url = "http://hl7.eu/fhir/ig/pcsp/StructureDefinition/Radiotherapy-min"
* name = "Radiotherapy-min"
* title = "Radiotherapy (minimal)"
* status = #draft
* experimental = true
* description = "Radiotherapy"
...
* kind = #logical
* abstract = true
* type = "Radiotherapy-min"
* baseDefinition = "http://hl7.org/fhir/StructureDefinition/Element"
* derivation = #specialization
* differential.element[0].id = "Radiotherapy-min"
* differential.element[0].path = "Radiotherapy-min"
* differential.element[0].short = "Radiotherapy"
* differential.element[0].definition = "Radiotherapy"
* differential.element[0].min = 1
* differential.element[0].max = "1"
* differential.element[1].id = "Radiotherapy-min.type"
* differential.element[1].path = "Radiotherapy-min.type"
...
* differential.element[2].id = "Radiotherapy-min.startDate"
* differential.element[2].path = "Radiotherapy-min.startDate"
...
* differential.element[3].id = "Radiotherapy-min.target"
* differential.element[3].path = "Radiotherapy-min.target"
...
* differential.element[4].id = "Radiotherapy-min.target.site"
* differential.element[4].path = "Radiotherapy-min.target.site"
...
* differential.element[5].id = "Radiotherapy-min.target.comulativeDose"
* differential.element[5].path = "Radiotherapy-min.target.comulativeDose"
...
* differential.element[6].id = "Radiotherapy-min.target.comulativeDose.notKnown"
* differential.element[6].path = "Radiotherapy-min.target.comulativeDose.notKnown"
...
* differential.element[7].id = "Radiotherapy-min.target.comulativeDose.dose"
* differential.element[7].path = "Radiotherapy-min.target.comulativeDose.dose"
...
* differential.element[8].id = "Radiotherapy-min.target.comulativeDose.unit"
* differential.element[8].path = "Radiotherapy-min.target.comulativeDose.unit"
...
* differential.element[9].id = "Radiotherapy-min.target.boost"
* differential.element[9].path = "Radiotherapy-min.target.boost"
...
* differential.element[10].id = "Radiotherapy-min.target.boost.given"
* differential.element[10].path = "Radiotherapy-min.target.boost.given"
...
* differential.element[11].id = "Radiotherapy-min.target.boost.site"
* differential.element[11].path = "Radiotherapy-min.target.boost.site"
...
* differential.element[12].id = "Radiotherapy-min.target.boost.comulativeDose"
* differential.element[12].path = "Radiotherapy-min.target.boost.comulativeDose"
...
* differential.element[13].id = "Radiotherapy-min.target.boost.comulativeDose.notKnown"
* differential.element[13].path = "Radiotherapy-min.target.boost.comulativeDose.notKnown"
...
* differential.element[14].id = "Radiotherapy-min.target.boost.comulativeDose.dose"
* differential.element[14].path = "Radiotherapy-min.target.boost.comulativeDose.dose"
...
* differential.element[15].id = "Radiotherapy-min.target.boost.comulativeDose.unit"
* differential.element[15].path = "Radiotherapy-min.target.boost.comulativeDose.unit"
...
* differential.element[16].id = "Radiotherapy-min.radionuclides"
* differential.element[16].path = "Radiotherapy-min.radionuclides"
